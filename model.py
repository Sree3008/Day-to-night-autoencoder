...
def save_img_samples(batches_done):
    ...
    path =  '/tested' + "/%s.png" % (batches_done)
...
def train(
    ...
    for epoch in tqdm(range(hp.epoch, n_epochs), desc="Epochs"):
        ...
        for i, batch in enumerate(train_dataloader):
            ...
            loss_G.backward()
            torch.nn.utils.clip_grad_norm_(Gen_AB.parameters(), max_norm=1.5)
            torch.nn.utils.clip_grad_norm_(Gen_BA.parameters(), max_norm=1.5)
            optimizer_G.step()
            ...
            torch.nn.utils.clip_grad_norm_(Disc_A.parameters(), max_norm=1.5)
            ...
            torch.nn.utils.clip_grad_norm_(Disc_B.parameters(), max_norm=1.0)
...
if __name__ == "__main__":
    ...
    day_images_path = 'C:/Users/Admin/Downloads/imgToImg/day/*.jpg'
    night_images_path = 'C:/Users/Admin/Downloads/imgToImg/night/*.jpg'
